...
<form class="max-w-sm mx-auto">
    ...
    <div class="flex items-start mb-5">
      ...
      <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Remember me <a href="{{route('forgotPassword')}}" class="text-blue-600 hover:underline dark:text-blue-500 mx-16">ForgotPassword?</a></label>
    </div>
    ...
    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-12"><a href="{{route('signin')}}">SigIn</a></button>
</form>
